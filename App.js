...
const App = () => {
  ...
  // const [timer, onChangeTimer] = React.useState(15);
  ...
  const TestQuestion = (props) => {
    return (
      <View>
        ...
        {Timer(props.timerVariable)}
      </View>
    )
  }

  const TestScreen = (questionObj) => {
  ...
  const testHandler = (testObj, index) => {

    testObj = testOneTab
    return TestScreen(testObj.tasks[0])
    ...
    return (
      ...
      {/* <View style={styles.resultContainer}>*/}
        ...
        <FlatList
          ...
          keyExtractor={(item) => item.nick+' '+item.date+' '+item.score+' '+item.type}
  ...
  const CustomDrawerContent = ({ navigation }) => {
    return (
      <View>
        <NavigationItem screenName="Home" screenNameUI="Home" navigation={navigation}/>
        <NavigationItem screenName="Results" screenNameUI="Results" navigation={navigation}/>
        <View style={[{borderBottomWidth: 2, borderColor: "#000000", margin: 10}]}/>
        <NavigationItem screenName="Test-1" screenNameUI="Test 1" navigation={navigation}/>
        <NavigationItem screenName="Test 2" screenNameUI="Results" navigation={navigation}/>
      </View>
    );
  }
      ...
      <NavigationContainer onReady={() =>  RNBootSplash.hide({ fade: true })}>
        ...
        <Drawer.Navigator initialRouteName="Home"
          ...
          <Drawer.Screen
            ...
            options={({ navigation }) => ({HomeScreen})}
          />
          <Drawer.Screen
            name="Results"
            component={ResultScreen}
            options={({ navigation }) => ({ResultScreen})}
          />
          <Drawer.Screen
            name="Test-1"
            component={testHandler}
            options={({ navigation }) => ({testHandler})}
          />
        </Drawer.Navigator>
      </NavigationContainer>
    );
